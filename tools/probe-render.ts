...
const HUD_STATE: HudState = { training: 42, canLevelUp: true, muted: false, silent: false, toast: '', arrow: '분열 살', stars: -1, endReason: '', arrowRule: false, time: 12.4, bestTime: 9.8, record: false }
